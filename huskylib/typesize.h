...
#if (defined(__linux__) && !defined(__alpha)) || defined(__FreeBSD__) || defined(__NetBSD__)|| defined(__DJGPP__) || defined(__BEOS__) || defined(__OpenBSD__) || defined(__CYGWIN__) || defined(__QNXNTO__)
typedef   signed char       CHAR;               /*  1 byte */
typedef unsigned char      UCHAR;               /*  1 byte */
typedef   signed int        INT32;              /*  4 byte */
typedef unsigned int       UINT32;              /*  4 byte */
